...
\begin{document}
    ...
    \begin{figure}[htbp]
        \centerline{\includegraphics{arduino-connection}}
    ...
    \begin{figure}[htbp]
        \centerline{\includegraphics{led}}
        \caption{LED}
        \label{fig}
    \end{figure}

    \begin{figure}[htbp]
        \centerline{\includegraphics{jumper-wires}}
        \caption{Jumper Wires}
        \label{fig}
    \end{figure}

    \begin{figure}[htbp]
        \centerline{\includegraphics{pcb-connector}}
        \caption{PCB}
        \label{fig}
    \end{figure}
